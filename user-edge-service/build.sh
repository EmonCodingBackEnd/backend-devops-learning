...
sudo docker build -t 192.168.200.116:5080/devops-learning/user-edge-service:latest .

sudo docker push 192.168.200.116:5080/devops-learning/user-edge-service:latest
